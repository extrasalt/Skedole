...
~~~sh
# getting the code
git clone git@github.com:nko5/imperial-clan.git && cd ./imperial-clan/
...
# deploying to Modulus (to http://imperial-clan.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/imperial-clan" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
